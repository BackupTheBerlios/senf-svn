...
namespace senf {
    ...
    public:
        ...
        typedef detail::Parse_List_Iterator<ElementParser,
                                            typename ListPolicy::iterator_policy> iterator;
        typedef Parse_List_Container<ElementParser,ListPolicy> container;
    ...
    private:
        friend class Parse_List_Container<ElementParser,ListPolicy>;
    };
        ...
        struct iterator_policy 
        {
            iterator setBegin(iterator i, state_type s); ///< Initialize iterator to begin()
                                        /**< Initialize the policy from the given List (i,s). Set
                                             ...
                                             \important if the list is empty, the returned iterator
            ...
            iterator next(iterator i, state_type s) const; ///< Advance to next element
                                        /**< given an iterator to an element, go to the next
                                             element. */

            iterator raw(iterator i, state_type s) const; ///< Return raw position of element
    ...
    public:
        ...
        typedef Parse_List<ElementParser,ListPolicy> parser_type;
